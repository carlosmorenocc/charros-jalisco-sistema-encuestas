        ...
        <form onSubmit={submit} noValidate>
          <div className="drawer-body manual-body">
            ...
            {step === 1 && <><fieldset><legend>Clasificación comercial</legend><div className="form-grid">
              <label className="field"><span>Clasificación *</span><select autoFocus value={draft.subscriberStatus} onChange={(event) => update('subscriberStatus', event.target.value)}><option value="prospect">Prospecto</option><option value="current_subscriber">Abonado actual</option><option value="renewing">Por renovar</option><option value="new_subscriber">Abonado nuevo</option><option value="former_subscriber">Exabonado</option></select></label>
