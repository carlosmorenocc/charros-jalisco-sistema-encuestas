...
export function fromApiSale(sale) {
  ...
  return {
    ...
    priceBookVersion: sale.priceBookVersion || null,
    section: sale.section || null,
    localityCode: sale.localityCode || null,
    localityName: sale.localityName || null,
    discountCode: sale.discountCode || null,
    discountName: sale.discountName || null,
    pricingMode: sale.pricingMode || null,
